        ...
        {callState === 'calling' && (
          <div className="flex flex-col items-center justify-center text-center gap-8 px-6">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-3xl font-bold text-white tracking-tight">{remoteUser?.username}</p>
              <p className="text-white/40 text-sm font-medium tracking-wide uppercase">Calling…</p>
            </div>
            <CallTypeBadge type={callType} />
            <button
              onClick={endCall}
              title="Cancel call"
              className="mt-6 p-5 rounded-full bg-red-600 text-white shadow-xl shadow-red-600/40 transition-all duration-200 hover:scale-110 hover:bg-red-500 active:scale-95"
            >
              <PhoneOff className="w-7 h-7" />
            </button>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center gap-8 px-6">
            <div className="relative">
              ...
              <img
                src={getAvatarUrl(remoteUser?.username || '')}
                alt={remoteUser?.username}
                className="relative w-32 h-32 rounded-full border-4 border-white/20 object-cover shadow-2xl z-10 animate-bounce"
              />
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-3xl font-bold text-white tracking-tight">{remoteUser?.username}</p>
              <p className="text-white/40 text-sm font-medium tracking-wide uppercase">Incoming Call…</p>
            </div>
            <CallTypeBadge type={callType} />
            <div className="flex gap-6 mt-6">
              ...
              <button
                onClick={acceptCall}
                title="Accept"
                className="p-5 rounded-full bg-green-500 text-white shadow-xl shadow-green-500/40 transition-all duration-200 hover:scale-110 hover:bg-green-400 active:scale-95"
              >
